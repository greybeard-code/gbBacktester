"""GodZillaKilla -- YM three-amigos on r40-10 ninZaRenko (2026-08-09).

Same 3-of-3 TH+PA+SJ gate, all-hours (no window), as
godzilla_ym_three_amigos_r80.py -- r80-20 prints too slowly to watch live,
so this halves the brick (same 4:1 brick:trend ratio) per user request.
...
class GodZillaYMThreeAmigosR40(_mod.GodZillaKilla):
    symbol = "YM"
    period = "r40-10"
